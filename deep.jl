...
fold_img = rand(1:numFolds)
fold_label = rand(1:numFolds)
...
ann = Chain(
    ...
    #   Se toman 3 salidas porque tenemos 3 clases (3 estilos de arte)
    # Entradas a esta capa: matriz 4D de dimension 288 x <numPatrones>
    # Salidas de esta capa: matriz 4D de dimension  33 x <numPatrones>
    Dense(288, 3),
